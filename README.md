## mrpt_ros (rolling) - 2.15.21-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Thu, 13 Aug 2026 18:12:55 -0000`
...
- rosdistro version: `2.15.20-1`
- old version: `2.15.20-1`
- new version: `2.15.21-1`
...
## mrpt_ros (lyrical) - 2.15.21-1

The packages in the `mrpt_ros` repository were released into the `lyrical` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r lyrical mrpt_ros` on `Thu, 13 Aug 2026 18:09:16 -0000`
...
## mrpt_ros (kilted) - 2.15.21-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Thu, 13 Aug 2026 18:05:32 -0000`
...
## mrpt_ros (jazzy) - 2.15.21-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Thu, 13 Aug 2026 18:00:48 -0000`
...
## mrpt_ros (humble) - 2.15.21-2

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Thu, 13 Aug 2026 17:56:07 -0000`
...
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.20-1`
- old version: `2.15.21-1`
- new version: `2.15.21-2`
...
## mrpt_ros (humble) - 2.15.21-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Thu, 13 Aug 2026 14:36:18 -0000`
...
## mrpt_ros (rolling) - 2.15.20-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Tue, 28 Jul 2026 07:52:59 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.19-1`
- old version: `2.15.19-1`
- new version: `2.15.20-1`
...
## mrpt_ros (lyrical) - 2.15.20-1

The packages in the `mrpt_ros` repository were released into the `lyrical` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r lyrical mrpt_ros` on `Tue, 28 Jul 2026 07:49:22 -0000`
...
## mrpt_ros (kilted) - 2.15.20-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Tue, 28 Jul 2026 07:45:46 -0000`
...
## mrpt_ros (jazzy) - 2.15.20-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Tue, 28 Jul 2026 07:41:22 -0000`
...
## mrpt_ros (humble) - 2.15.20-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Tue, 28 Jul 2026 07:36:58 -0000`
...
## mrpt_ros (rolling) - 2.15.19-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Fri, 03 Jul 2026 07:31:18 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.18-1`
- old version: `2.15.18-1`
- new version: `2.15.19-1`
...
## mrpt_ros (lyrical) - 2.15.19-1

The packages in the `mrpt_ros` repository were released into the `lyrical` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r lyrical mrpt_ros` on `Fri, 03 Jul 2026 07:28:21 -0000`
...
## mrpt_ros (kilted) - 2.15.19-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Fri, 03 Jul 2026 07:25:24 -0000`
...
## mrpt_ros (jazzy) - 2.15.19-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Fri, 03 Jul 2026 07:06:31 -0000`
...
## mrpt_ros (humble) - 2.15.19-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Fri, 03 Jul 2026 07:02:40 -0000`
...
## mrpt_ros (kilted) - 2.15.18-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/mnt/linux/home/jlblanco/code/bloom-venv/bin/bloom-release -r kilted -y mrpt_ros` on `Thu, 14 May 2026 21:43:36 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.14-1`
- old version: `2.15.14-1`
- new version: `2.15.18-1`
...
## mrpt_ros (jazzy) - 2.15.18-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/mnt/linux/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt_ros` on `Thu, 14 May 2026 21:36:29 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.17-1`
- old version: `2.15.17-1`
- new version: `2.15.18-1`
...
## mrpt_ros (humble) - 2.15.18-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/mnt/linux/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt_ros` on `Thu, 14 May 2026 21:31:42 -0000`
...
## mrpt_ros (rolling) - 2.15.18-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Tue, 12 May 2026 21:35:15 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.17-2`
- old version: `2.15.17-2`
- new version: `2.15.18-1`
...
## mrpt_ros (lyrical) - 2.15.18-1

The packages in the `mrpt_ros` repository were released into the `lyrical` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r lyrical mrpt_ros` on `Tue, 12 May 2026 21:31:55 -0000`
...
## mrpt_ros (rolling) - 2.15.17-2

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Mon, 11 May 2026 18:49:30 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.16-1`
- old version: `2.15.17-1`
- new version: `2.15.17-2`
...
## mrpt_ros (lyrical) - 2.15.17-2

The packages in the `mrpt_ros` repository were released into the `lyrical` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r lyrical mrpt_ros` on `Mon, 11 May 2026 18:46:23 -0000`
...
## mrpt_ros (jazzy) - 2.15.17-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Mon, 11 May 2026 18:34:30 -0000`
...
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.15-1`
- old version: `2.15.15-1`
- new version: `2.15.17-1`
...
## mrpt_ros (humble) - 2.15.17-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Mon, 11 May 2026 18:30:16 -0000`
...
## mrpt_ros (rolling) - 2.15.17-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Sat, 09 May 2026 07:43:52 -0000`
...
## mrpt_ros (lyrical) - 2.15.17-1

The packages in the `mrpt_ros` repository were released into the `lyrical` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r lyrical mrpt_ros` on `Sat, 09 May 2026 07:38:10 -0000`
...
## mrpt_ros (rolling) - 2.15.16-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling -y mrpt_ros` on `Thu, 07 May 2026 10:50:35 -0000`
...
## mrpt_ros (lyrical) - 2.15.16-1

The packages in the `mrpt_ros` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release -r lyrical -y mrpt_ros` on `Thu, 07 May 2026 10:45:25 -0000`
...
## mrpt_ros (rolling) - 2.15.15-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Tue, 05 May 2026 10:07:28 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.14-2`
- old version: `2.15.14-2`
- new version: `2.15.15-1`
...
## mrpt_ros (lyrical) - 2.15.15-1

The packages in the `mrpt_ros` repository were released into the `lyrical` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r lyrical mrpt_ros` on `Tue, 05 May 2026 09:58:41 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.14-3`
- old version: `2.15.14-3`
- new version: `2.15.15-1`
...
## mrpt_ros (jazzy) - 2.15.15-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Tue, 05 May 2026 09:47:10 -0000`
...
## mrpt_ros (humble) - 2.15.15-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Tue, 05 May 2026 09:41:05 -0000`
...
## mrpt_ros (rolling) - 2.15.14-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling -y mrpt_ros` on `Mon, 20 Apr 2026 15:55:45 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.13-1`
- old version: `2.15.13-1`
- new version: `2.15.14-1`
...
## mrpt_ros (jazzy) - 2.15.14-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt_ros` on `Mon, 20 Apr 2026 15:51:02 -0000`
...
## mrpt_ros (kilted) - 2.15.14-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r kilted -y mrpt_ros` on `Mon, 20 Apr 2026 15:46:19 -0000`
...
## mrpt_ros (humble) - 2.15.14-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt_ros` on `Mon, 20 Apr 2026 15:41:41 -0000`
...
## mrpt_ros (rolling) - 2.15.13-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Tue, 14 Apr 2026 11:11:17 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.12-1`
- old version: `2.15.12-1`
- new version: `2.15.13-1`
...
## mrpt_ros (kilted) - 2.15.13-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Tue, 14 Apr 2026 11:04:22 -0000`
...
## mrpt_ros (jazzy) - 2.15.13-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Tue, 14 Apr 2026 10:55:13 -0000`
...
## mrpt_ros (humble) - 2.15.13-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Tue, 14 Apr 2026 10:49:49 -0000`
...
## mrpt_ros (rolling) - 2.15.12-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling -y mrpt_ros` on `Mon, 06 Apr 2026 08:30:14 -0000`
...
- upstream repository: https://github.com/MRPT/mrpt_ros.git
- release repository: https://github.com/ros2-gbp/mrpt_ros-release.git
- rosdistro version: `2.15.11-1`
- old version: `2.15.11-1`
- new version: `2.15.12-1`
...
## mrpt_ros (kilted) - 2.15.12-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r kilted -y mrpt_ros` on `Mon, 06 Apr 2026 08:25:40 -0000`
...
## mrpt_ros (jazzy) - 2.15.12-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt_ros` on `Mon, 06 Apr 2026 08:20:17 -0000`
...
## mrpt_ros (humble) - 2.15.12-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt_ros` on `Mon, 06 Apr 2026 08:12:03 -0000`
...
## mrpt_ros (rolling) - 2.15.11-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Thu, 12 Mar 2026 15:08:09 -0000`
...
## mrpt_ros (kilted) - 2.15.11-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Thu, 12 Mar 2026 15:03:29 -0000`
...
## mrpt_ros (rolling) - 2.15.8-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -y -r rolling mrpt_ros` on `Sun, 08 Feb 2026 18:30:24 -0000`
...
## mrpt_ros (humble) - 2.15.8-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/usr/bin/bloom-release -y -r humble mrpt_ros` on `Sun, 08 Feb 2026 18:14:58 -0000`
...
## mrpt_ros (rolling) - 2.15.7-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Tue, 03 Feb 2026 21:38:39 -0000`
...
## mrpt_ros (jazzy) - 2.15.7-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Tue, 03 Feb 2026 21:34:03 -0000`
...
## mrpt_ros (kilted) - 2.15.7-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Tue, 03 Feb 2026 21:29:24 -0000`
...
## mrpt_ros (humble) - 2.15.7-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Tue, 03 Feb 2026 21:24:46 -0000`
...
## mrpt_ros (rolling) - 2.15.6-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Thu, 29 Jan 2026 21:42:15 -0000`
...
## mrpt_ros (kilted) - 2.15.6-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Thu, 29 Jan 2026 21:38:04 -0000`
...
## mrpt_ros (jazzy) - 2.15.6-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Thu, 29 Jan 2026 21:29:53 -0000`
...
## mrpt_ros (humble) - 2.15.6-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Thu, 29 Jan 2026 21:25:44 -0000`
...
## mrpt_ros (rolling) - 2.15.5-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling -y mrpt_ros` on `Sat, 10 Jan 2026 09:09:24 -0000`
...
## mrpt_ros (jazzy) - 2.15.5-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt_ros` on `Sat, 10 Jan 2026 09:02:59 -0000`
...
## mrpt_ros (kilted) - 2.15.5-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r kilted -y mrpt_ros` on `Sat, 10 Jan 2026 08:57:47 -0000`
...
## mrpt_ros (humble) - 2.15.5-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt_ros` on `Sat, 10 Jan 2026 08:53:03 -0000`
...
## mrpt_ros (rolling) - 2.15.4-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Fri, 26 Dec 2025 16:20:56 -0000`
...
## mrpt_ros (kilted) - 2.15.4-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Fri, 26 Dec 2025 16:16:07 -0000`
...
## mrpt_ros (jazzy) - 2.15.4-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Fri, 26 Dec 2025 16:11:52 -0000`
...
## mrpt_ros (humble) - 2.15.4-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Fri, 26 Dec 2025 16:07:29 -0000`
...
## mrpt_ros (rolling) - 2.15.3-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Sat, 20 Dec 2025 11:39:23 -0000`
...
## mrpt_ros (kilted) - 2.15.3-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Sat, 20 Dec 2025 11:34:36 -0000`
...
## mrpt_ros (jazzy) - 2.15.3-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Sat, 20 Dec 2025 11:20:16 -0000`
...
## mrpt_ros (humble) - 2.15.3-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Sat, 20 Dec 2025 11:15:50 -0000`
...
## mrpt_ros (rolling) - 2.15.2-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Fri, 21 Nov 2025 10:03:39 -0000`
...
## mrpt_ros (kilted) - 2.15.2-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Fri, 21 Nov 2025 09:58:52 -0000`
...
## mrpt_ros (jazzy) - 2.15.2-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r jazzy mrpt_ros` on `Fri, 21 Nov 2025 09:54:09 -0000`
...
## mrpt_ros (humble) - 2.15.2-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Fri, 21 Nov 2025 09:49:41 -0000`
...
## mrpt_ros (rolling) - 2.15.1-2

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling -y mrpt_ros` on `Wed, 29 Oct 2025 12:57:02 -0000`
...
## mrpt_ros (kilted) - 2.15.1-2

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r kilted -y mrpt_ros` on `Wed, 29 Oct 2025 12:52:37 -0000`
...
## mrpt_ros (jazzy) - 2.15.1-2

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt_ros` on `Wed, 29 Oct 2025 12:48:20 -0000`
...
## mrpt_ros (humble) - 2.15.1-2

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt_ros` on `Wed, 29 Oct 2025 12:43:57 -0000`
...
## mrpt_ros (rolling) - 2.15.1-1

The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling -y mrpt_ros` on `Wed, 29 Oct 2025 09:31:51 -0000`
...
## mrpt_ros (kilted) - 2.15.1-1

The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r kilted -y mrpt_ros` on `Wed, 29 Oct 2025 09:26:46 -0000`
...
## mrpt_ros (jazzy) - 2.15.1-1

The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt_ros` on `Wed, 29 Oct 2025 09:21:28 -0000`
...
## mrpt_ros (humble) - 2.15.1-1

The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt_ros` on `Wed, 29 Oct 2025 09:17:00 -0000`
...
The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt_ros` on `Sun, 26 Oct 2025 20:02:05 -0000`
...
The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r kilted mrpt_ros` on `Wed, 15 Oct 2025 08:25:27 -0000`
...
The packages in the `mrpt_ros` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r kilted mrpt_ros` on `Sat, 27 Sep 2025 08:30:56 -0000`
...
The packages in the `mrpt_ros` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -y -r jazzy mrpt_ros` on `Mon, 09 Dec 2024 08:54:01 -0000`
...
The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Sat, 19 Oct 2024 14:32:54 -0000`
...
The packages in the `mrpt_ros` repository were released into the `iron` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r iron mrpt_ros` on `Sat, 12 Oct 2024 09:38:34 -0000`
...
The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt_ros` on `Tue, 24 Sep 2024 22:05:20 -0000`
...
The packages in the `mrpt_ros` repository were released into the `iron` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r iron mrpt_ros` on `Sun, 15 Sep 2024 15:28:02 -0000`
...
The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt_ros` on `Thu, 29 Aug 2024 07:46:49 -0000`
...
The packages in the `mrpt_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -y -r rolling mrpt_ros` on `Sun, 18 Aug 2024 19:14:21 -0000`
...
The packages in the `mrpt_ros` repository were released into the `humble` distro by running `/usr/bin/bloom-release -y -r humble mrpt_ros` on `Sun, 18 Aug 2024 18:24:01 -0000`
...
The packages in the `mrpt_ros` repository were released into the `iron` distro by running `/usr/bin/bloom-release -y -r iron mrpt_ros` on `Wed, 14 Aug 2024 08:54:35 -0000`
